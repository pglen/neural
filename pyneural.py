...
def test_tfunc():
    ...
    for aa in range(-190, 190):
        ...
        cnt += 1
        if cnt % 10 == 0:
            print("%+0.3f=%+0.3f/%+0.3f     " % (val, val2, val3), end=' ')
    gtk.main()
...
if __name__ == '__main__':
    ...
    if conf.xtra:
        ...
        print("in1:", end=' ') ;neu.showin()
        neu.fire();
        arr1 = neu.getout()

        neu.setinput((0.10,0.10,0.30,0.10,0.10,0.10,0.10,0.10))
        print("in2:", end=' ') ; neu.showin()
        neu.fire();
        arr2 = neu.getout()

        print("out1", end=' ') ;   printarr(arr1)
        print("out2", end=' ') ;   printarr(arr2)
    ...
    print("value  a ", end=' ') ;  printarr(value_a)
    print("value  b ", end=' ') ;  printarr(value_b)
    print("value  c ", end=' ') ;  printarr(value_c)
    print()
    ...
    #neu.showin()
    neu.fire()
    print("actual a ", end=' ') ;  neu.showout()
    arr1 = neu.getout()

    neu.setinput(value_b)
    #neu.showin()
    neu.fire()
    print("actual b ", end=' ')  ; neu.showout()
    arr2 = neu.getout()

    neu.setinput(value_c)
    #neu.showin()
    neu.fire()
    print("actual c ", end=' ') ;  neu.showout()
    arr3 = neu.getout()
